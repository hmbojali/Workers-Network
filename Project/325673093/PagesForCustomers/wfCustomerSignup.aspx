<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfCustomerSignup.aspx.cs" Inherits="PagesForCustomers_wfCustomerSignup" %>
...
<body style="height:100%; background-color:#FFDD77">
    <form id="formCustomer" runat="server" style="height:100%">
                          ...
                          <li style="margin-bottom:10px; display:flex;flex-direction:column; align-items:center">
                           ...
                           <li style="display:flex; flex-direction:column; align-items:center; background-color:#FFAA33; padding:30px">
                               <div style="display:flex; flex-direction:row; align-items:center; margin-bottom:20px">
                                   ...
                                   <asp:Label ID="lblCustomerID" runat="server" Text="ID Number"  style="height: 30px; margin-right:15px" ForeColor="#FF2200" Font-Bold="true" Font-Size="30px" Visible="False"></asp:Label>
                                   <asp:TextBox ID="inputCustomerID" runat="server" placeholder="..." style="height: 30px; width:120px; margin-right:40px" ForeColor="Red" Font-Size="20px" BackColor="#FF9922" BorderColor="#FF7700" BorderStyle="Outset" Visible="False"></asp:TextBox>
                               ...
                               <div style="display:flex; flex-direction:row; align-items:center;">
                                   ...
                                   <asp:Label ID="lblAddressDescription" runat="server" Text="Address Description"  style="height: 30px; margin-right:15px" ForeColor="#FF2200" Font-Bold="true" Font-Size="30px" Visible="False"></asp:Label>
                                   <asp:TextBox ID="inputAddressDescription" runat="server" placeholder="city, area, street, building number..." style="height: 30px; width:150px; margin-right:40px" ForeColor="Red" Font-Size="20px" BackColor="#FF9922" BorderColor="#FF7700" BorderStyle="Outset" Visible="False"></asp:TextBox>

                               </div>

                           </li>
                       </ul>
                        <div style="display:flex;flex-direction:row-reverse;align-items:end center; padding:0 0 0 0px">
                         <asp:Button ID="btnSumbit" runat="server" Text="Next" ForeColor="#BB0000" Font-Size="18px" BackColor="#FF5500" BorderColor="#FF3300" BorderStyle="Outset" BorderWidth="4px" Width="120px" Height="40px" OnClick="btnSumbit_Click"/>
                             <div style="display:flex; align-items:center">
                                ...
                                <asp:RegularExpressionValidator ID="ValidatorID" runat="server" style="margin-right:5px; border-left:solid; border-color:red; padding-left:2px" ControlToValidate="inputCustomerID" ErrorMessage="Wrong ID Format" ValidationExpression="\d{9}" Visible="false"></asp:RegularExpressionValidator>
